...
<div class="flex flex-col gap-6">
        ...
        <div class="flex items-center font-title w-fit overflow-hidden rounded-2xl shadow-sm border border-gray-200 mt-2">
            ...
            <a
                href="#"
                class="px-10 py-3 text-xl font-bold transition bg-[#D91E2E] opacity-25 text-white pointer-events-none cursor-not-allowed"
                disabled
            >
                Peserta
            </a>
            ...
            <a
                ...
                class="px-10 py-3 text-xl font-bold transition shadow-2xl"
            >
                Panitia
            </a>
