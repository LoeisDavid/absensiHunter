<!-- Header -->
    <header class="flex items-center justify-between font-title sm:px-5 relative z-30">
        ...
        <div class="hidden lg:flex items-center font-title lg:gap-4 xl:gap-12 font-bold lg:text-md xl:text-lg">
        ...
        <div class="flex items-center font-body">
            <div class="hidden lg:flex items-center gap-2 sm:gap-4">
                <a href="{{ route('scan') }}" class="shadow-md border-3 p-2 xl:px-6 lg:px-3 lg:py-2 sm:bg-transparent sm:shadow-none text-graphite hover:text-[#4d4d4d] transition inline-flex items-center gap-2 font-bold font-title rounded-r-lg rounded-bl-lg lg:text-base xl:text-lg">
                    <span>Scan</span>
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="bg-graphite hover:bg-[#4d4d4d] transition text-white p-2 xl:px-6 lg:px-3 lg:py-2 rounded-r-lg rounded-bl-lg shadow-sm lg:font-semibold xl:font-bold cursor-pointer inline-flex items-center gap-2 lg:text-base xl:text-lg font-title">
                        <span>Log out</span>
